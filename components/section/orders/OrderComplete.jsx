        ...
        <Container>
            ...
            <div className=" w-full my-5 flex flex-col justify-center items-center">
                ...
                <div className="mx-4 md:mx-0 font-Rokkitt text-4xl font-bold text-center py-8">
                    <h2>
                        Thank you for purchasing, Your order is complete. Please
                ...
                <div className="w-full flex justify-center items-center">
                    <Link href="/">
                        <button className=" p-4 bg-transparent border border-black cursor-pointer hover:bg-primary hover:text-white transition-all duration-300 ease-linear rounded-3xl font-bold mr-3">
                            Home
                        </button>
                    </Link>
                    <Link href="/">
